...
test_that("apa.d.table table.body is a matrix with correct columns", {
     ...
     expect_true(is.matrix(t1$table.body))
     col_names <- colnames(t1$table.body)
