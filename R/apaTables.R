...
#'   \item ANOVA tables - An ANOVA F-table can be created via \code{\link{apa.anova.table}} from a regression object (i.e. lm output). Cell mean/standard deviation tables for 1- and 2-way designs are created from data frames using \code{\link{apa.1way.table}} and \code{\link{apa.2way.table}}.
